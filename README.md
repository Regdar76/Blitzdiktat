...
> Hinweis: Dieses Repository ist öffentlich. Vor jedem Push prüfen, dass keine Secrets (API-Keys, Signing-Keys) oder sensiblen Daten enthalten sind — siehe [SECURITY.md](SECURITY.md).
