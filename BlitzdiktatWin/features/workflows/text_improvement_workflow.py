...
class TextImprovementWorkflow(BaseWorkflow):
    def __init__(
        ...
        super().__init__(WorkflowType.TEXT_IMPROVER)
    ...
    def _run(self) -> None:
        ...
        try:
            ...
            self._set_phase(WorkflowPhase.PROCESSING, "Wird verbessert ...")
            loop = asyncio.new_event_loop()
            improved = loop.run_until_complete(llm_service.improve(raw, self._settings))
            loop.close()
