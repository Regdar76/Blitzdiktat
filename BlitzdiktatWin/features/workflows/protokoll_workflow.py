...
PROTOKOLL_SYSTEM_PROMPT = (
    ...
    "- Beginne das Protokoll mit einer kurzen Zusammenfassung in 2–4 Sätzen, "
    "die so geschrieben ist, dass auch eine Person, die nicht dabei war und den "
    "Rest des Protokolls nicht liest, sofort versteht, worum es ging: Anlass bzw. "
    "Thema, die wichtigsten Inhalte und das zentrale Ergebnis. Die Zusammenfassung "
    ...
    "---\n\n"
    "### Zusammenfassung\n"
    "[2–4 Sätze, die auch einer außenstehenden Person sofort klarmachen, worum es "
    "ging: Anlass/Thema, Kerninhalte und zentrales Ergebnis — selbsterklärend, ohne "
    "den Rest des Protokolls lesen zu müssen]\n\n"
    "### Besprochene Punkte\n"
    "- [Punkt 1]\n"
    "- [Punkt 2]\n\n"
    "### Entscheidungen\n"
